	...
	<%@ include file="includePage.jsp" %>
        ...
        <fieldset>
            ...
            <table border="1px">
                ...
                <tr>
                    <th>* 이름</th>
                    <td><input type="text" required name="userName" placeholder="이름 입력하시오."></td>
                </tr>
                <tr>
                    <th>* 전화번호</th>
                ...
                <tr>
                    <th>* 배송주소</th>
                    <td><input type="text" name="address" required placeholder="주소 입력하라 ㅋ"></td>
                </tr>
                <tr>
                    <th>요청사항</th>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <select name="pizza">
                            ...
                            <option value="불고기피자">불고기자</option>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" name="side" value="갈릭소스"> 갈릭
